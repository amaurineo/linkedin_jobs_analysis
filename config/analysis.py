...
ROLE_PATTERNS = {
    ...
    'Engenheiro de Dados': [
        ...
        r'\bpessoa\s+engenheir(a|o)\s+de\s+dados\b',
    ],
    'Engenheiro de IA': [
        r'\b((?:artificial intelligence|ai)\s+engineer|engenheiro de (?:ia\b|intelig[êe]ncia artificial)|engenheiro\s+ai)\b',
        r'\b(engineer|engenheiro)\b(?:\W+\w+){0,3}?\W+(?:ia\b|ai\b|intelig[êe]ncia artificial|artificial intelligence)\b',
        r'\b(?:ia\b|ai\b|intelig[êe]ncia artificial|artificial intelligence)\b(?:\W+\w+){0,3}?\W+\b(engineer|engenheiro)\b',
    ...
    'Analista de Dados': [
        ...
        r'\bespecialista\s+em\s+an[áa]lise\s+de\s+dados\b',
        r'\breporting\b.*\bdados\b',
        r'\b(analista|assistente|especialista)\b.*\bdados\b',
